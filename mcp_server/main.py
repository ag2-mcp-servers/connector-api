...
def apis_all(
    ...
    filter: Optional[ApisFilter] = None,
):
    """
    List APIs
    """
...
def apis_one(
    x_apideck_app_id: str = Header(..., alias='x-apideck-app-id'), id: str = ...
):
    """
    Get API
    """
...
@app.get(
    ...
    tags=['connector_documentation_management', 'api_resource_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def connectors_all(
    ...
    cursor: Optional[str] = None,
    limit: Optional[conint(ge=1, le=200)] = 20,
    filter: Optional[ConnectorsFilter] = None,
):
    """
    List Connectors
    """
...
@app.get(
    ...
    tags=['connector_documentation_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.get(
    ...
    tags=['api_resource_management', 'connector_documentation_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
